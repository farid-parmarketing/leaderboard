...
fetch(
  "https://raw.githubusercontent.com/farid-parmarketing/leaderboard/main/assets/json/csgobig.json"
)
  .then((response) => {
    if (!response.ok) {
  ...
  .then((winnersData) => {
    const winnersGrid = document.getElementById("csgobig-winner-grid");
    const winnersTable = document.getElementById("csgobig-winners-table");
