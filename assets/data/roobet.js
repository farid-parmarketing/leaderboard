...
fetch(
  "https://raw.githubusercontent.com/farid-parmarketing/leaderboard/main/assets/json/roobet.json"
)
  .then((response) => {
    if (!response.ok) {
  ...
  .then((winnersData) => {
    const winnersGrid = document.getElementById("roobet-winner-grid");
    const winnersTable = document.getElementById("roobet-winners-table");
