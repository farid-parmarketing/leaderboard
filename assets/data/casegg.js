...
fetch(
  "https://raw.githubusercontent.com/farid-parmarketing/leaderboard/main/assets/json/casesgg.json"
)
  .then((response) => {
    if (!response.ok) {
  ...
  .then((winnersData) => {
    const winnersGrid = document.getElementById("casegg-winner-grid");
    const winnersTable = document.getElementById("casegg-winners-table");
